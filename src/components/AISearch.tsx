...
const suggestions = [
  ...
  "Tell me about the Generali experience",
  "Which deep dives focus on finance?",
  "What data engineering tools does Jonathan use?",
  ...
  return (
    <section className="py-32 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Suggestions — show only when no result and not loading */}
            ...
            >
              ...
              <div className="p-5 bg-surface border border-border rounded-xl">
                <div className="flex items-center gap-2 mb-3">
                  <Sparkles size={14} className="text-accent" />
                  <span className="text-xs font-mono text-accent">AI Answer</span>
              ...
              {result.relatedProjects.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 text-xs text-muted font-mono mb-3">
                    ...
                    <span>
                      {result.relatedProjects.length} related project
                      {result.relatedProjects.length > 1 ? "s" : ""}
                    </span>
                  </div>
                  ...
                  <div className="space-y-3">
                    {result.relatedProjects.map((project, i) => (
                      <motion.a
                        ...
                        className="block p-4 bg-surface border border-border rounded-xl hover:border-accent/20 transition-colors"
                      >
